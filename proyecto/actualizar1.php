...
if (!empty($_POST))
{
    ...
    $consul = " UPDATE alimentos set nom='$nom', des='$des', prov='$prov', vru='$vru', cant='$cant' WHERE id='$id'";
...
<div class="container">
     ...
     <div class="form-group">
         ...
         <form class="form-horizontal" action="actualizar1.php" method="post">
           ...
           <div class="form-actions">
               ...
               <a class="btn btn-primary" href="listar1.php">Regresar</a>
             </div>
         </form>
     </div>
