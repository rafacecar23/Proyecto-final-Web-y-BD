...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_title">
			<h2>Lista de productos de panadería</h2>
    ...
    <table class="table">
        ...
        <tbody>
            <?php
                ...
                $i=1;
                $consulta=$conexion->query("Select * from panaderia");
            ...
            <tr class="table-primary">
                ...
                <td width=240px>
                    <?php 
                        echo "<div class='btn-group'><div class='btn-group mr-2'><form action='borrar2.php' method='get'><input type='hidden' name='idb2' value='".$datos['id']."'><input type='submit' class='btn btn-danger' value='Borrar'></form></div>";
                        echo "<div class='btn-group mr-2'><form action='actualizar2.php' method='get'><input type='hidden' name='idb2' value='".$datos['id']."'><input type='submit' class='btn btn-success' value='Actualizar'></form></div></div>";
                    ?>
                </td>
            </tr>
